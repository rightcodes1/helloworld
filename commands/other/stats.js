...
exports.run = async (client, message, args) => {
  let embed = new Discord.MessageEmbed()
    ...
    .addField(`:alarm_clock: Uptime`, "" + (Math.round(client.uptime / (1000 * 60 * 60))) + " Hours(s), " + (Math.round(client.uptime / (1000 * 60)) % 60) + " minute(s) et " + (Math.round(client.uptime / 1000) % 60) + " second(s)" + "")
